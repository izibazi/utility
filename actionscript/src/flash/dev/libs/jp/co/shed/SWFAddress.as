...
/**
 * 
 * change to private class  by ishibashi;
 * 
 * private static var _value:String = '';//change to public by ishibashi;
 * 
    ...
    public class SWFAddress {
       ...
       // private static var _value:String = '';//change to public by ishibashi;
        ...
        public static function setValue(value:String):void {
			...
			//trace("SWFAddress._value" + SWFAddress._value);
            if (SWFAddress._init) {
                _dispatchEvent(SWFAddressEvent.CHANGE);
            } else {
                _initChanged = true;
